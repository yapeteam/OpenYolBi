...
public interface IBrowser {
     ...
     */
    void sendMouseMove(int x, int y, int mods, boolean left);
     ...
     * @param y       The Y coord of the mouse.
     * @param mods    The key modifiers (shift, ctrl, alt)
     * @param button     The mouse button to press. See {@link java.awt.event.MouseEvent}
     ...
     */
    void sendMouseButton(int x, int y, int mods, int button, boolean pressed, int ccnt);
     ...
     * @param mods The key modifiers (shift, ctrl, alt)
     */
    void sendKeyTyped(int key, int mods);

    /**
     * Simulates a key press.
     *
     * @param key LWJGL key code of the pressed key.
     * @param c       The resulting character
     * @param mods    The key modifiers (shift, ctrl, alt)
     */
    void sendKeyPressed(int key, char c, int mods);
     ...
     * @param mods    The key modifiers (shift, ctrl, alt)
     */
    void sendKeyReleased(int key, char c, int mods);
     ...
     */
    void sendMouseWheel(int x, int y, int mods, int amount, int rot);
